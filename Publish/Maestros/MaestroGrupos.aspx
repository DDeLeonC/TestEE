<%@ Page Language="C#" MasterPageFile="~/MasterPages/Maestros.Master" AutoEventWireup="true" CodeBehind="MaestroGrupos.aspx.cs" Inherits="Interfaz_Web.Maestros.MaestroGrupos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="divTitulo">
    <asp:Label ID="lblReportes" runat="server" Text="Grupos"  Font-Bold="true"></asp:Label>
    </div>
    <div></div>
    <div>
        ...
        <asp:Table ID="Table3" runat="server">
                 <asp:TableRow ID="TableRow1" runat="server" Width="742px">
                    ...
                    <asp:TableCell ID="TableCell2" runat="server" Width="371px" HorizontalAlign="Right">
                        <asp:Button ID="ButtonNuevo" runat="server" CssClass="botonGenerarReporte" Text="Nuevo" PostBackUrl="~/Maestros/NuevoGrupo.aspx"/>
                    </asp:TableCell>
                </asp:TableRow>
        </asp:Table>
                            ...
                            <asp:TemplateField ItemStyle-Width = "60px">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkRemove" runat="server" 
                                        CommandArgument = '<%# Eval("IdGrupo")%>'
                                     OnClientClick = "return confirm('Desea eliminar el grupo?')"
