<%@ Page Language="C#" MasterPageFile="~/MasterPages/Maestros.Master" AutoEventWireup="true" CodeBehind="MaestrosVendedores.aspx.cs" Inherits="InterfazWeb.Maestros.MaestrosVendedores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="divTitulo">
    <asp:Label ID="lblReportes" runat="server" Text="Vendedores"  Font-Bold="true"></asp:Label>
    </div>
    <div></div>
    <div>
        ...
        <asp:Table ID="Table3" runat="server">
                 <asp:TableRow ID="TableRow1" runat="server" Width="742px">
                    ...
                    <asp:TableCell ID="TableCell2" runat="server" Width="371px" HorizontalAlign="Right">
                        <asp:Button ID="ButtonNuevo" runat="server" CssClass="botonGenerarReporte" Text="Nuevo" PostBackUrl="~/Maestros/NuevoVendedor.aspx"/>
                    </asp:TableCell>
                </asp:TableRow>
        </asp:Table>
            ...
            <asp:Table ID="Table2" runat="server">
                ...
                <asp:TableRow ID="TableRow4" runat="server">
                    <asp:TableCell ID="TableCell6" runat="server">
                        ...
                        <asp:GridView ID="gridViewVendedores" runat="server"  CssClass="grid-view" AutoGenerateColumns ="false" CellSpacing="0" 
                            CellPadding="0" BorderStyle="None" onrowcreated="gridViewVendedores_RowCreated" AllowPaging ="true"   
                            ...
                            <asp:TemplateField ItemStyle-Width = "25px"  HeaderText = "Id" Visible = "false">
                                <ItemTemplate>
                                    <asp:Label ID="lblIdVendedor" runat="server"
                                    Text='<%# Eval("IdVendedor")%>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField ItemStyle-Width = "60px">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkRemove" runat="server" 
                                     ...
                                     OnClientClick = "return confirm('Desea eliminar el vendedor?')"
