<%@ Page Language="C#" MasterPageFile="~/MasterPages/Transacciones.Master" AutoEventWireup="true" 
    CodeBehind="NotaCredito.aspx.cs" Inherits="InterfazWeb.Transacciones.NotaCredito" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" 
        ...
        Format="dd/MM/yyyy" />
    <div class="divTitulo">
    <asp:Label ID="lblReportes" runat="server" Text="Nota Crédito"  Font-Bold="true"></asp:Label>
    </div>
    <div>
    </div>
