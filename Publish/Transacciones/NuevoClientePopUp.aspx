<%@ Page Language="C#" MasterPageFile="~/MasterPages/PopUpMaster.Master" AutoEventWireup="true" CodeBehind="~/Transacciones/NuevoClientePopUp.aspx.cs" Inherits="InterfazWeb.Transacciones.NuevoClientePopUp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <script type="text/javascript"">
        function cancelPopUpCliente() {
            window.parent.document.getElementById('btnCancelCliente').click();
        }
    </script>
    <div class="divTitulo">
            ...
            <asp:Table ID="Table5" runat="server">
                     <asp:TableRow ID="TableRow2" runat="server" Width="742px">
                        <asp:TableCell ID="TableCell5" runat="server" Width="500px" HorizontalAlign="right">
                            ...
                            <Button id="btnSalirCliente" runat="server" class="botonGenerarReporte" style="margin-left: 15px;" onclick="cancelPopUpCliente();">Salir</Button>              
                        </asp:TableCell>
