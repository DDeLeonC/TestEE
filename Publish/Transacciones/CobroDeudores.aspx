<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Transacciones.Master"
    CodeBehind="CobroDeudores.aspx.cs" Inherits="InterfazWeb.Transacciones.CobroDeudores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="divTitulo">
        <asp:Label ID="lblReportes" runat="server" Text="Cobro a Deudor" Font-Bold="true"></asp:Label>
    </div>
    <div>
    </div>
            ...
            <asp:Table ID="Table10" runat="server" Width="742px" Height="20px">
                <asp:TableRow ID="TableRow17" runat="server">
                    ...
                    <asp:TableCell ID="TableCell40" runat="server" Width="350px">
                        <asp:DropDownList ID="ddlClientes" Width="300px" class="chzn-select" runat="server">
                        </asp:DropDownList>
                    </asp:TableCell>
            ...
            <asp:Table ID="Table5" runat="server">
                <asp:TableRow ID="TableRow2" runat="server" Width="742px">
                    <asp:TableCell ID="TableCell5" runat="server" Width="450px" HorizontalAlign="Right">
                        <asp:Button ID="btnBuscar" runat="server" CssClass="botonGenerarReporte" Text="Estado de Cuenta"
            ...
            <asp:Table ID="Table4" runat="server" Width="742px" Height="20px">
                <asp:TableRow ID="TableRow8" runat="server">
                    <asp:TableCell ID="TableCell1" runat="server" Width="200px">
                        <asp:Label ID="Label7" runat="server" Text="Importe a Pagar *" CssClass="bodyText"></asp:Label>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell2" runat="server">
                        <asp:TextBox ID="txtSaldo" Width="300px" runat="server"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell3" runat="server" HorizontalAlign="Left">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSaldo"
                            ErrorMessage="Debe ingresar el importe" ForeColor="Red" ToolTip="Debe ingresar el importe"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Debe ingresar un decimal"
                            ForeColor="Red" ControlToValidate="txtSaldo" ValidationExpression="(^[0-9]*[1-9]+[0-9]*\,[0-9]*$)|(^[0-9]*\,[0-9]*[1-9]+[0-9]*$)|(^[0-9]*[1-9]+[0-9]*$)" />
            ...
            <asp:Table ID="Table6" runat="server" Width="742px" Height="20px">
                <asp:TableRow ID="TableRow5" runat="server">
                    <asp:TableCell ID="TableCell12" runat="server" Width="200px">
                        <asp:Label ID="Label3" runat="server" Text="Nro. Recibo *" CssClass="bodyText"></asp:Label>
                    </asp:TableCell><asp:TableCell ID="TableCell13" runat="server">
                        <asp:TextBox ID="txtNroRecibo" Width="300px" runat="server" Enabled="true"></asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell14" runat="server" HorizontalAlign="Left">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Debe ingresar un número"
                            ForeColor="Red" ControlToValidate="txtNroRecibo" ValidationExpression="(^[0-9]*$)" />
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </div>
            ...
            <asp:Table ID="Table2" runat="server">
                <asp:TableRow ID="TableRow3" runat="server" Width="742px">
                    <asp:TableCell ID="TableCell4" runat="server" Width="450px" HorizontalAlign="Center">
                        <asp:Button ID="btnCobrar" runat="server" CssClass="botonGenerarReporte" Text="Cobrar"
