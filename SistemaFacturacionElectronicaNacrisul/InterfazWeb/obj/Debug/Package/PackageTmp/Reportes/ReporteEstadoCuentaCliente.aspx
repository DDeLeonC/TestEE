<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Reportes.Master" CodeBehind="ReporteEstadoCuentaCliente.aspx.cs" Inherits="InterfazWeb.Reportes.ReporteEstadoCuentaCliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="divTitulo">
    <asp:Label ID="lblReportes" runat="server" Text="Cuenta Corriente Clientes"  Font-Bold="true"></asp:Label>
    </div>
    <div></div>
    <div>
                ...
                <asp:TableRow ID="TableRow6" runat="server" Width="742px">
                  ...
                  <asp:TableRow ID="TableRow2" runat="server" Width="742px">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlCliente" 
                           ErrorMessage="Debe seleccionar un cliente" ForeColor="Red" ToolTip="Debe seleccionar un cliente" EnableClientScript="false" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </asp:TableCell>
                ...
                <asp:TableRow ID="TableRow4" runat="server">
                    <asp:TableCell ID="TableCell6" runat="server">
                        ...
                        <asp:GridView ID="gridViewDocumentos" runat="server"  CssClass="grid-view" AutoGenerateColumns ="false" CellSpacing="0" 
                            ...
                            <asp:TemplateField ItemStyle-Width = "200px"  HeaderText = "Detalle">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField ItemStyle-Width = "80px"  HeaderText = "Debe">
                                <ItemTemplate>
                                    <asp:Label ID="lblDebe" runat="server"
                                            Text='<%# Eval("Debe")%>'></asp:Label>
                                </ItemTemplate>
                                
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width = "80px"  HeaderText = "Haber">
                                <ItemTemplate>
                                    <asp:Label ID="lblHaber" runat="server"
                                            Text='<%# Eval("Haber")%>'></asp:Label>
                                </ItemTemplate>
