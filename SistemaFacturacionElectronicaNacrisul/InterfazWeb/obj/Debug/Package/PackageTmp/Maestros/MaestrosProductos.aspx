<%@ Page Language="C#" MasterPageFile="~/MasterPages/Maestros.Master" AutoEventWireup="true" CodeBehind="MaestrosProductos.aspx.cs" Inherits="InterfazWeb.Maestros.MaestrosProductos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="divTitulo">
    <asp:Label ID="lblReportes" runat="server" Text="Productos"  Font-Bold="true"></asp:Label>
    </div>
    <div></div>
    <div>
    <asp:Table ID="Table1" runat="server">
            ...
            <asp:TableRow ID="TableRow2" runat="server">
                <asp:TableCell ID="TableCell3" runat="server">
                    <asp:Label ID="lblCodigo" runat="server"   Text="Codigo" CssClass="bodyText"></asp:Label>                
                </asp:TableCell>
                <asp:TableCell ID="TableCell4" runat="server">
                    <asp:TextBox ID="txtCodigo"  Width="300px" runat="server" CssClass="bodyText"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="Fila3" runat="server">
                ...
                <asp:TableCell ID="Celda32" runat="server">
                    <asp:DropDownList ID="cbxGrupo" Width="300px" runat="server" CssClass="bodyText" OnSelectedIndexChanged="ddlGrupo_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow ID="TableRow3" runat="server">
                <asp:TableCell ID="TableCell5" runat="server">
                    <asp:Label ID="Label2" runat="server" Text="SubGrupo" CssClass="bodyText"></asp:Label>                
                </asp:TableCell>
                <asp:TableCell ID="TableCell7" runat="server">
                    <asp:DropDownList ID="cbxSubGrupo" Width="300px" runat="server" CssClass="bodyText"></asp:DropDownList>
                </asp:TableCell>
            </asp:TableRow>
        ...
        <asp:Table ID="Table3" runat="server">
                 <asp:TableRow ID="TableRow1" runat="server" Width="742px">
                    ...
                    <asp:TableCell ID="TableCell2" runat="server" Width="371px" HorizontalAlign="Right">
                        <asp:Button ID="ButtonNuevo" runat="server" CssClass="botonGenerarReporte" Text="Nuevo" PostBackUrl="~/Maestros/NuevoProducto.aspx"/>
                    </asp:TableCell>
                </asp:TableRow>
        </asp:Table>
                ...
                <asp:TableRow ID="TableRow4" runat="server">
                    <asp:TableCell ID="TableCell6" runat="server">
                        ...
                        <asp:GridView ID="gridViewClientes" runat="server"  CssClass="grid-view" AutoGenerateColumns ="false" CellSpacing="0" 
                            ...
                            <asp:TemplateField ItemStyle-Width = "60px"  HeaderText = "Codigo">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField ItemStyle-Width = "60px"  HeaderText = "Descripcion">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField ItemStyle-Width = "250px"  HeaderText = "SubGrupo">
                                <ItemTemplate>
                                    <asp:Label ID="lblSubGrupo" runat="server"
                                            Text='<%# Eval("SubGrupo")%>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                        <asp:Label ID="lblSubGrupo" runat="server" Text='<%# Eval("SubGrupo")%>' Visible = "false"></asp:Label>
                            ...
                            <asp:TemplateField ItemStyle-Width = "60px"  HeaderText = "Unidad">
                                <ItemTemplate>
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtUnidad" runat="server"
                                        Text='<%# Eval("unidadMedida")%>' ></asp:TextBox>
                                </EditItemTemplate> 
                                
                            </asp:TemplateField>
                            <asp:TemplateField ItemStyle-Width = "250px"  HeaderText = "Indicador de Facturacion">
                                <ItemTemplate>
                                    <asp:Label ID="lblindicador" runat="server"
                                            Text='<%# Eval("indicador")%>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                        <asp:Label ID="lblindicador" runat="server" Text='<%# Eval("indicador")%>' Visible = "false"></asp:Label>
                                <asp:DropDownList ID = "ddlindicador" runat = "server"></asp:DropDownList>
                                </EditItemTemplate>  
                            ...
                            <asp:TemplateField ItemStyle-Width = "60px">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkRemove" runat="server" 
                                     ...
                                     OnClientClick = "return confirm('Desea eliminar el producto?')"
