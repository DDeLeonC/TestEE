<%@ Page Language="C#" MasterPageFile="~/MasterPages/Maestros.Master" AutoEventWireup="true" CodeBehind="NuevaZona.aspx.cs" Inherits="InterfazWeb.Maestros.NuevaZona" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="divTitulo">
    <asp:Label ID="lblReportes" runat="server" Text="Nueva Zona"  Font-Bold="true"></asp:Label>
    </div>
    <div></div>
    <div>
