<%@ Page Language="C#" MasterPageFile="~/MasterPages/Maestros.Master" AutoEventWireup="true" CodeBehind="NuevoVendedor.aspx.cs" Inherits="InterfazWeb.Maestros.NuevoVendedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="divTitulo">
    <asp:Label ID="lblReportes" runat="server" Text="Nuevo Vendedor"  Font-Bold="true"></asp:Label>
    </div>
    <div></div>
    <div>
