<%@ Page Language="C#" MasterPageFile="~/MasterPages/Maestros.Master" AutoEventWireup="true" CodeBehind="NuevoSubGrupo.aspx.cs" Inherits="Interfaz_Web.Maestros.NuevoSubGrupo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div class="divTitulo">
    <asp:Label ID="lblReportes" runat="server" Text="Nuevo SubGrupo"  Font-Bold="true"></asp:Label>
    </div>
    <div></div>
    <div>
         ...
         <asp:Table ID="Table4" runat="server" Width="742px" Height="20px">
                <asp:TableRow ID="Fila4" runat="server">
                    ...
                    <asp:TableCell ID="TableCell10" runat="server">
                        <asp:DropDownList ID="ddlGrupo" Width="300px" runat="server" ></asp:DropDownList>
                    </asp:TableCell>
                    <asp:TableCell ID="TableCell1" runat="server" HorizontalAlign="Left">
                    <asp:RequiredFieldValidator ID="GrupoObligatorio" runat="server" ControlToValidate="ddlGrupo" 
                       ErrorMessage="Debe seleccionar el grupo" ForeColor="Red" ToolTip="Debe seleccionar el grupo" ></asp:RequiredFieldValidator>
