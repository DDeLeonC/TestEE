<%@ Page Language="C#" MasterPageFile="~/MasterPages/Reportes.Master" AutoEventWireup="true" CodeBehind="InformePorcentajesClientes.aspx.cs" Inherits="InterfazWeb.Reportes.InformePorcentajesClientes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" 
            ...
            Format="dd/MM/yyyy" />
    <div class="divTitulo">
        <asp:Label ID="lblReportes" runat="server" Text="Listado por Cliente"  Font-Bold="true"></asp:Label>
    </div>
    <div></div>
    <div>
        <asp:Table ID="Table6" runat="server" Width="742px" Height="20px">
            ...
            <asp:TableRow ID="TableRow3" runat="server">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlMoneda" 
                    ErrorMessage="Debe seleccionar el vendedor" ForeColor="Red" EnableClientScript="false" Display="Dynamic" SetFocusOnError="true" ToolTip="Debe seleccionar el vendedor" ></asp:RequiredFieldValidator>
                    ...
                    <asp:TableCell ID="TableCell6" runat="server">
                        ...
                        <asp:GridView ID="gridViewDocumentos" runat="server"  CssClass="grid-view" AutoGenerateColumns ="false" CellSpacing="0" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width = "100px"  HeaderText = "Nro Documento">
                                    <ItemTemplate>
