...
{
    public partial class InformePorcentajesClientes : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            try
            {
                ...
                gridViewDocumentos.DataSource = Sistema.GetInstancia().ObtenerPorcentajePorClientes(Session["rut"].ToString(), ddlMoneda.SelectedValue, DateTime.Parse(txtFechaDesde.Text), DateTime.Parse(txtFechaHasta.Text), idVendedor);
        ...
        private void ExportGridToExcel()
        {
            ...
            try
            {
                ...
                foreach (TableCell cell in gridViewDocumentos.HeaderRow.Cells)
                {
                    ...
                    {
                        if (cell.Text.Equals("Total Acumulado"))
                        {
                ...
                foreach (GridViewRow row in gridViewDocumentos.Rows)
                {
                    ...
                    Label lblCliente = row.FindControl("lblNombre") as Label;
                    if (lblCliente != null)
                    {
                ...
                using (XLWorkbook wb = new XLWorkbook())
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=InformePorcentajesPorCliente.xlsx");
