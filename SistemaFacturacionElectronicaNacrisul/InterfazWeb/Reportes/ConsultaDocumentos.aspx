<%@ Page Language="C#" MasterPageFile="~/MasterPages/Reportes.Master" EnableEventValidation = "false"  AutoEventWireup="true" CodeBehind="ConsultaDocumentos.aspx.cs" Inherits="InterfazWeb.Reportes.ConsultaDocumentos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" 
            ...
            Format="dd/MM/yyyy" />
    <div class="divTitulo">
    <asp:Label ID="lblReportes" runat="server" Text="Consulta Documentos"  Font-Bold="true"></asp:Label>
    </div>
    <div></div>
    <div>
    <asp:Table ID="Table1" runat="server" Width="742px">     
                <asp:TableRow ID="TableRow6" runat="server" Width="742px">
                  ...
                  <asp:TableRow ID="TableRow10" runat="server" Width="742px">
                        <asp:TableCell ID="TableCell15" runat="server" Width="210px">
                            <asp:Label ID="Label6" runat="server" Text="Estado" CssClass="bodyText"></asp:Label>                
                        </asp:TableCell>
                        <asp:TableCell ID="TableCell19" runat="server" Width="350px">
                            <asp:DropDownList ID="ddlEstado" Width="300px"  runat="server" ></asp:DropDownList>
                        </asp:TableCell>
                  ...
                  <asp:TableRow ID="TableRow11" runat="server" Width="742px">
                        <asp:TableCell ID="TableCell26" runat="server" Width="210px">
                            <asp:Label ID="Label11" runat="server" Text="Nro. Guia" CssClass="bodyText"></asp:Label>                
                        </asp:TableCell>
                        <asp:TableCell ID="TableCell27" runat="server" Width="350px">
                  ...
                  <asp:TableRow ID="TableRow12" runat="server" Width="742px">
                        <asp:TableCell ID="TableCell29" runat="server" Width="210px">
                            <asp:Label ID="Label13" runat="server" Text="Nro. Remito" CssClass="bodyText"></asp:Label>                
                        </asp:TableCell>
                ...
                <asp:TableRow ID="TableRow4" runat="server">
                    <asp:TableCell ID="TableCell6" runat="server">
                        ...
                        <asp:GridView ID="gridViewDocumentos" runat="server"  CssClass="grid-view" AutoGenerateColumns ="false" CellSpacing="0" 
                            ...
                            <asp:TemplateField ItemStyle-Width = "120px"  HeaderText = "Cliente">
                                <ItemTemplate>
